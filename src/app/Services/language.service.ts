...
const TRANSLATION_MAP: Record<string, TranslationItem> = {
  ...
  'რჩეული და პოპულარული ლოკაციები': { eng: 'Most Chosen & Popular Places', rus: 'Самые популярные места' },
  'საქართველოს ყველაზე მოთხოვნადი და რჩეული ლოკაციები': { eng: 'Most requested and top-rated locations in Georgia', rus: 'Самые востребованные и топовые локации в Грузии' },
  'ყველაზე მოთხოვნადი': { eng: 'Most Chosen', rus: 'Самые популярные' },
  'ტოპ რჩეული': { eng: 'Top Choice', rus: 'Топ выбор' },
  'დასადასტურებელი': { eng: 'Pending Approvals', rus: 'На утверждении' },
  'დასადასტურებელი ლოკაციები': { eng: 'Pending Locations for Approval', rus: 'Локации на утверждении' },
  'დადასტურებული ლოკაციები:': { eng: 'Approved Places:', rus: 'Одобренные места:' },
  'ახალი ლოკაციების დადასტურება, წაშლა, მომხმარებლების მართვა და ბლოკირება.': {
    eng: 'Approve new places, delete locations, manage users and ban accounts.',
    rus: 'Утверждение новых мест, удаление локаций, управление пользователями и блокировка.'
  },
  'მართვის პანელი': { eng: 'Control Dashboard', rus: 'Панель управления' },
  'ლოკაციების წაშლა, მომხმარებლების მართვა, ადმინისტრატორების დანიშვნა და ბლოკირება.': {
    eng: 'Delete locations, manage users, assign administrator roles and ban accounts.',
    rus: 'Удаление локаций, управление пользователями, назначение администраторов и блокировка.'
  },
  'სტატისტიკა': { eng: 'Statistics', rus: 'Статистика' },
  'ლოკაციების მართვა': { eng: 'Manage Places', rus: 'Управление местами' },
  'მომხმარებლები': { eng: 'Users', rus: 'Пользователи' },
  'უსაფრთხოება & პაროლები': { eng: 'Security & Passwords', rus: 'Безопасность и пароли' },
  'სულ ლოკაციები': { eng: 'Total Places', rus: 'Всего мест' },
  'მომხმარებელი': { eng: 'User', rus: 'Пользователь' },
  'ადმინისტრატორი': { eng: 'Administrator', rus: 'Администратор' },
  'დაბლოკილი (Banned)': { eng: 'Banned', rus: 'Заблокирован' },
  'ადმინისტრირების შესაძლებლობები': { eng: 'Admin Capabilities', rus: 'Возможности администратора' },
  'ლოკაციების მართვა & წაშლა': { eng: 'Manage & Delete Places', rus: 'Управление и удаление мест' },
  'სულ ლოკაცია:': { eng: 'Total Places:', rus: 'Всего мест:' },
  'მომხმარებლების მართვა & როლები': { eng: 'Manage Users & Roles', rus: 'Управление пользователями и ролями' },
  'რეგისტრირებული მომხმარებლები:': { eng: 'Registered Users:', rus: 'Зарегистрированные пользователи:' },
  'ადმინ პანელის მონაცემები': { eng: 'Admin Panel Credentials', rus: 'Данные админ панели' },
  ...
  'გადახდები & ჯავშნები': { eng: 'Payments & Bookings', rus: 'Оплаты и бронирования' },
  'გადახდის გაფორმება': { eng: 'Checkout & Payment', rus: 'Оформление оплаты' },
  'შეიყვანეთ საბანკო ბარათის მონაცემები ტურის დასაჯავშნად': { eng: 'Enter credit card details to book your tour', rus: 'Введите данные банковской карты для бронирования тура' },
  'ბარათის მფლობელის სახელი და გვარი': { eng: 'Cardholder Full Name', rus: 'Имя и фамилия владельца карты' },
  'ბარათის 16-ნიშნა ნომერი': { eng: '16-Digit Card Number', rus: '16-значный номер карты' },
  'მოქმედების ვადა': { eng: 'Expiration Date', rus: 'Срок действия' },
  'CVC / CVV კოდი': { eng: 'CVC / CVV Code', rus: 'Код CVC / CVV' },
  'შეკვეთის დეტალები': { eng: 'Order Summary', rus: 'Детали заказа' },
  'არჩეული ტური': { eng: 'Selected Tour', rus: 'Выбранный тур' },
  'შესული სერვისები': { eng: 'Included Services', rus: 'Включенные сервисы' },
  'სულ გადასახდელი თანხა': { eng: 'Total Amount Payable', rus: 'Итого к оплате' },
  'სულ შემოსავალი': { eng: 'Total Revenue', rus: 'Общая выручка' },
  'სულ შემოსავალი (Revenue)': { eng: 'Total Revenue', rus: 'Общий доход' },
  'საკრედიტო ბარათების გადახდები & ჯავშნები': { eng: 'Credit Card Payments & Bookings', rus: 'Оплаты по картам и бронирования' },
  'მომხმარებლების მიერ განხორციელებული გადახდების რეესტრი': { eng: 'Customer Payment Transaction Records', rus: 'Реестр платежей клиентов' },
  'ჯავშნის ID': { eng: 'Booking ID', rus: 'ID Брони' },
  'გადახდის მეთოდი': { eng: 'Payment Method', rus: 'Способ оплаты' },
  'გადახდილი სულ': { eng: 'Total Paid', rus: 'Всего оплачено' },
  'მთავარ გვერდზე დაბრუნება': { eng: 'Return to Homepage', rus: 'Вернуться на главную' },
  'ადმინ პანელში ნახვა': { eng: 'View in Admin Panel', rus: 'Просмотреть в админ панели' },
  'შეკვეთის სრული დეტალები': { eng: 'Complete Order Details', rus: 'Полные детали заказа' },
  'მომხმარებლის ინფორმაცია': { eng: 'Customer Information', rus: 'Информация о клиенте' },
  'არჩეული ტური და თარიღი': { eng: 'Selected Tour & Date', rus: 'Выбранный тур и дата' },
  'შეკვეთილი სერვისები და პაკეტები': { eng: 'Ordered Services & Packages', rus: 'Заказанные услуги и пакеты' },
  'გადახდის ბარათის მონაცემები': { eng: 'Payment Card Details', rus: 'Данные платежной карты' },
  'სტატუსის შეცვლა': { eng: 'Change Status', rus: 'Изменить статус' },
  'ქვითრის დაბეჭდვა': { eng: 'Print Receipt', rus: 'Распечатать чек' },
  'დახურვა': { eng: 'Close', rus: 'Закрыть' },
  'შეკვეთის დრო': { eng: 'Order Time', rus: 'Время заказа' },
  'დაჯავშნილი თარიღი': { eng: 'Booked Date', rus: 'Забронированная дата' },
  'მოგზაურთა რაოდენობა': { eng: 'Number of Travelers', rus: 'Количество путешественников' },
  'სულ გადახდილი': { eng: 'Total Paid', rus: 'Всего оплачено' },
  'დეტალები': { eng: 'Details', rus: 'Детали' },
  ...
  // Tour Builder Services
  'ტურის სერვისები / ტურის აწყობა': { eng: 'Tour Services / Build Your Tour', rus: 'Сервисы тура / Соберите свой тур' },
  'აირჩიეთ დამატებითი სერვისები და შექმენით იდეალური ტური': { eng: 'Select additional services to customize your ideal tour', rus: 'Выберите дополнительные сервисы и создайте идеальный тур' },
  '1. ტრანსპორტირება 🚐': { eng: '1. Transportation 🚐', rus: '1. Транспорт 🚐' },
  '2. ტრადიციული სადილი 🍽️': { eng: '2. Traditional Lunch 🍽️', rus: '2. Традиционный обед 🍽️' },
  '3. ღვინის / კერძების დეგუსტაცია 🍷': { eng: '3. Wine / Food Tasting 🍷', rus: '3. Дегустация вин / еды 🍷' },
  '4. ტურის გიდი 🧑‍🏫': { eng: '4. Tour Guide 🧑‍🏫', rus: '4. Экскурсовод 🧑‍🏫' },
  '5. დამატებითი სერვისები ➕': { eng: '5. Additional Services ➕', rus: '5. Дополнительные услуги ➕' },
  'თქვენი ტური': { eng: 'Your Tour', rus: 'Ваш тур' },
  'მოგზაურები': { eng: 'Travelers', rus: 'Путешественники' },
  'სულ': { eng: 'TOTAL', rus: 'ИТОГО' },
  'ადამიანი': { eng: 'people', rus: 'чел.' },
  'ადგილი არ არის საკმარისი': { eng: 'Not enough capacity', rus: 'Недостаточно мест' },
  'აირჩიეთ ტრანსპორტირება': { eng: 'Select Transportation', rus: 'Выберите транспорт' },
  'აირჩიეთ ტრადიციული სადილი': { eng: 'Select Traditional Lunch', rus: 'Выберите традиционный обед' },
  'აირჩიეთ დეგუსტაციის პაკეტები': { eng: 'Select Tasting Packages', rus: 'Выберите пакеты дегустации' },
  'აირჩიეთ ტურის გიდი': { eng: 'Select Tour Guide', rus: 'Выберите гида тура' },
  'დადასტურება ✓': { eng: 'Confirm ✓', rus: 'Подтвердить ✓' },
  'ტევადობა მორგებულია': { eng: 'Capacity adapted for', rus: 'Вместимость адаптирована для' },
  'მენიუ:': { eng: 'Menu:', rus: 'Меню:' },
  'პაკეტში შედის:': { eng: 'Package includes:', rus: 'В пакет входит:' },
  'ენები:': { eng: 'Languages:', rus: 'Языки:' },
  'გამოცდილება:': { eng: 'Experience:', rus: 'Опыт:' },
  'არ არის არჩეული': { eng: 'Not selected', rus: 'Не выбрано' },
  'სტუმარი': { eng: 'guest', rus: 'гость' },
  'აირჩიეთ ტრანსპორტი': { eng: 'Select Transport', rus: 'Выбрать транспорт' },
  'აირჩიეთ სადილი': { eng: 'Select Lunch', rus: 'Выбрать обед' },
  'აირჩიეთ დეგუსტაცია': { eng: 'Select Tasting', rus: 'Выбрать дегустацию' },
  'აირჩიეთ გიდი': { eng: 'Select Guide', rus: 'Выбрать гида' },
  'წაშლა': { eng: 'Remove', rus: 'Удалить' },
  'წლები გამოცდილება': { eng: 'years exp.', rus: 'лет опыта' },
